<template>
    <div class="min-h-screen  text-white py-20 px-4">
      <div class="max-w-3xl mx-auto">
        <h1 class="text-4xl font-bold mb-8 text-center" v-motion-slide-top>Get in Touch</h1>

        <div class="bg-white rounded-lg shadow-xl overflow-hidden" v-motion-slide-visible-once>
          <div class="p-8">
        ...
        <div class="mt-12 text-center" v-motion-slide-visible-once>
          ...
          <div class="flex justify-center space-x-6">
            ...
            <a href="https://github.com/Sahet-dev" class="text-gray-300 hover:text-white transition-colors duration-300">
            ...
            <a href="https://ro.linkedin.com/in/sahet-kakajanov-188639263" class="text-gray-300 hover:text-white transition-colors duration-300">
  ...
  const submitForm = async () => {
      try {
          const response = await axios.post(`${BASE_URL}/api/contact`, form.value);
