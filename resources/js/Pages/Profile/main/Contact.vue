            ...
            <div class="text-center space-y-6"  >
                ...
                <div class="flex justify-center space-x-8">
                    ...
                    <a href="#" class="transform hover:scale-110 transition-transform duration-300">
                        <svg class="h-6 w-6 text-slate-300 hover:text-teal-400" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- GitHub -->
                    <a
                        href="https://github.com/Sahet-dev"
                    ...
                    <!-- LinkedIn -->
                    <a
                        href="https://ro.linkedin.com/in/sahet-kakajanov-188639263"
                        class="transform hover:scale-110 transition-transform duration-300"
                    >
                        <svg class="h-6 w-6 text-slate-300 hover:text-teal-400" fill="currentColor" viewBox="0 0 24 24">
